...
static struct clk_dummy ufs_card_rx_symbol_0_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
...
static struct clk_dummy ufs_card_rx_symbol_1_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
...
static struct clk_dummy ufs_card_tx_symbol_0_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
...
#ifndef CONFIG_MMC_DDR50_MAX_LIMIT
...
static struct clk_regmap *gcc_lahaina_clocks[] = {
...
static const struct qcom_reset_map gcc_lahaina_resets[] = {
...
static struct clk_hw *gcc_lahaina_hws[] = {
...
static const struct regmap_config gcc_lahaina_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc gcc_lahaina_desc = {
	.config = &gcc_lahaina_regmap_config,
	.clks = gcc_lahaina_clocks,
	.num_clks = ARRAY_SIZE(gcc_lahaina_clocks),
	.resets = gcc_lahaina_resets,
...
static const struct of_device_id gcc_lahaina_match_table[] = {
	{ .compatible = "qcom,lahaina-gcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, gcc_lahaina_match_table);

static int gcc_lahaina_probe(struct platform_device *pdev)
{
...
static int __init gcc_lahaina_init(void)
{
	return platform_driver_register(&gcc_lahaina_driver);
}
subsys_initcall(gcc_lahaina_init);

static void __exit gcc_lahaina_exit(void)
{
	platform_driver_unregister(&gcc_lahaina_driver);
}
module_exit(gcc_lahaina_exit);

MODULE_DESCRIPTION("QTI GCC LAHAINA Driver");
